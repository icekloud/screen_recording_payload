package com.e.sonic_attendance_proto.screen.transcoder;
...
import com.e.sonic_attendance_proto.screen.transcoder.source.FileDescriptorDataSource;
import com.e.sonic_attendance_proto.screen.transcoder.strategy.DefaultVideoStrategies;
import com.e.sonic_attendance_proto.screen.transcoder.strategy.TrackStrategy;
import com.e.sonic_attendance_proto.screen.transcoder.stretch.DefaultAudioStretcher;
import com.e.sonic_attendance_proto.screen.transcoder.time.DefaultTimeInterpolator;
import com.e.sonic_attendance_proto.screen.transcoder.time.SpeedTimeInterpolator;
...
import com.e.sonic_attendance_proto.screen.transcoder.validator.Validator;
...
import com.e.sonic_attendance_proto.screen.transcoder.resample.DefaultAudioResampler;
...
import com.e.sonic_attendance_proto.screen.transcoder.source.BlankAudioDataSource;
import com.e.sonic_attendance_proto.screen.transcoder.source.FilePathDataSource;
...
public class TranscoderOptions {
    ...
    public static class Builder {
         ...
         * Defaults to {@link DefaultTimeInterpolator}.
         *
         ...
         * and passing a {@link SpeedTimeInterpolator}.
